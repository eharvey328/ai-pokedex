...
[Pokedex API](https://quantum-coding-excercise-api.vercel.app/)

## Technology

- Typescript is the only required technology.
- You can use any framework you want: React, Vue, Svelte...
- You can use any meta-framework you want: Next, Nuxt, Remix, ... (_Please, don't waste your time configuring webpack manually_)
